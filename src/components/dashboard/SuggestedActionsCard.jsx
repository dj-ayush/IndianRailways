      ...
      <div className='p-5'>
        <div className='bg-blue-50 rounded-xl p-4 border border-blue-100'>
          ...
          <div className='mt-4 flex gap-3'>
            <button className='px-4 py-2 rounded-lg bg-gradient-to-br from-green-500 to-teal-600 text-white font-medium hover:from-green-600 hover:to-teal-700 transition-all shadow-md hover:shadow-lg'>
              Accept
            </button>
            <button className='px-4 py-2 rounded-lg bg-gradient-to-br from-gray-300 to-gray-400 text-gray-700 font-medium hover:from-gray-400 hover:to-gray-500 transition-all'>
              Reject
            </button>
          </div>
        </div>
